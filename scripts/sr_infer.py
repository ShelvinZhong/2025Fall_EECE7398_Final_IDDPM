...
def main():
    parser = argparse.ArgumentParser("Super-resolution inference script")
    parser.add_argument(
        "--config", type=str, required=True, help="YAML path"
    )
    parser.add_argument(
        "--model_path", type=str, required=True, help=".pt path"
    )
    parser.add_argument(
        "--lr_dir",
        type=str,
